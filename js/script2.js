    ...
    $("#wish-form").validate({
      ...
      messages: {
        ...
        content: {
          ...
          minlength: "Lời chúc phúc phải lớn hơn 10 ký tự.",
        },
        email: {
      ...
      submitHandler: function (form) {
        ...
        $.ajax({
          type: "POST",
          url: "https://script.google.com/macros/s/AKfycbyPdv6FWtoh8Wr6fjiT9u9vAs5xKEZHh6bGgn6yib5EqX-scIwDOVTDIWuO0k0cG1MB/exec",
          data: {
            name: name,
            email: email,
            comment: comment,
