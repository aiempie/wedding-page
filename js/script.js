(function ($) {
  ...
  smoothScrolling(
    $(".menu-section-area a[href^='#']"),
    $(".menu-section-area >nav").innerHeight()
  );
  /*======== Preloder ===========*/
  $.fakeLoader({
    bgColor: "#fff",
  ...
  if ($("#clock").length) {
    function timeElapse(date) {
      ...
      var html =
        '<div class="event-count-box"><div class="dash days_dash"><div class="digit">' +
        days +
        '</div></div> <span class="dash_title d-block text-center text-capitalize color-pink">' +
        $("#clock").data("text-day") +
        '</span> </div><div class="event-count-box"><div class="dash hours_dash"><div class="digit">' +
        hours +
        '</div></div> <span class="dash_title d-block text-center text-capitalize color-pink">' +
        $("#clock").data("text-hour") +
        '</span> </div><div class="event-count-box"><div class="dash minutes_dash"><div class="digit">' +
        minutes +
        '</div></div> <span class="dash_title d-block text-center text-capitalize color-pink">' +
        $("#clock").data("text-minute") +
        '</span> </div><div class="event-count-box"><div class="dash seconds_dash"><div class="digit">' +
        seconds +
        '</div></div> <span class="dash_title d-block text-center text-capitalize color-pink">' +
    ...
    $("#clock").countdown($("#clock").data("date"), function (event) {
      if (event.type == "stoped") {
        ...
        var $this = $(this).html(
          event.strftime(
            "" +
              ' <div class="event-count-box"><div class="dash days_dash"><div class="digit">%D</div></div> <span class="dash_title d-block text-center text-capitalize color-pink">' +
              $("#clock").data("text-day") +
              "</span> </div>" +
              ' <div class="event-count-box"><div class="dash hours_dash"><div class="digit">%H</div></div> <span class="dash_title d-block text-center text-capitalize color-pink">' +
              $("#clock").data("text-hour") +
              "</span> </div>" +
              ' <div class="event-count-box"><div class="dash minutes_dash"><div class="digit">%M</div></div> <span class="dash_title d-block text-center text-capitalize color-pink">' +
              $("#clock").data("text-minute") +
              "</span> </div>" +
              ' <div class="event-count-box"><div class="dash seconds_dash"><div class="digit">%S</div></div> <span class="dash_title d-block text-center text-capitalize color-pink">' +
              $("#clock").data("text-second") +
              "</span> </div>"
          )
        );
